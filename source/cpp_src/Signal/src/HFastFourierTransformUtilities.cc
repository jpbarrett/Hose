...
void
HFastFourierTransformUtilities::ComputeTwiddleFactors(unsigned int N, std::complex<double>* twiddle)
{
...
void
HFastFourierTransformUtilities::ComputeConjugateTwiddleFactors(unsigned int N, std::complex<double>* conj_twiddle)
{
    //This method is from:
    //An Algorithm for Computing the Mixed Radix Fast Fourier Transform
    //Richard C. Singleton
...
void
HFastFourierTransformUtilities::FFTRadixTwo_DIT(unsigned int N, std::complex<double>* data, std::complex<double>* twiddle)
{
    FFTRadixTwo_DIT(N, (double*)&(data[0]), (double*) &(twiddle[0]) );
}

void
HFastFourierTransformUtilities::FFTRadixTwo_DIF(unsigned int N, std::complex<double>* data, std::complex<double>* twiddle)
{
    FFTRadixTwo_DIF(N, (double*)&(data[0]), (double*) &(twiddle[0]) );
}

void
HFastFourierTransformUtilities::ButterflyRadixTwo_CooleyTukey(double* H0, double* H1, double* W)
{
    ////////////////////////////////////////////////////////////////////////
    //See page 23
...
void
HFastFourierTransformUtilities::ButterflyRadixTwo_GentlemanSande(double* H0, double* H1, double* W)
{
    ////////////////////////////////////////////////////////////////////////
    //See page 25
    //"Inside the FFT Black Box", E. Chu and A. George, Ch. 13, CRC Press, 2000
...
void
HFastFourierTransformUtilities::FFTRadixTwo_DIT(unsigned int N, double* data, double* twiddle)
{
    //decimation in time
    ...
    if(HBitReversalPermutation::IsPowerOfTwo(N) )
    {
        unsigned int logN = HBitReversalPermutation::LogBaseTwo(N);
        ...
        for(unsigned int stage = 0; stage < logN; stage++)
        {
            ...
            butterfly_width = HBitReversalPermutation::TwoToThePowerOf(stage);
    ...
    {
        std::cout<<"HFastFourierTransformUtilities::FFTRadixTwo_DIT: error, array has length: "<<N<<" which is not an integer power of 2."<<std::endl;
    }
}


void
HFastFourierTransformUtilities::FFTRadixTwo_DIF(unsigned int N, double* data, double* twiddle)
{
    ...
    if(HBitReversalPermutation::IsPowerOfTwo(N) )
    {
        ...
        {
            //compute the number of butterfly groups
            n_butterfly_groups= HBitReversalPermutation::TwoToThePowerOf(stage);
    ...
    {
        std::cout<<"HFastFourierTransformUtilities::FFTRadixTwo_DIF: error, array has length: "<<N<<" which is not an integer power of 2."<<std::endl;
    }
...
void
HFastFourierTransformUtilities::ButterflyRadixThree(std::complex<double>& H0,
...
void
HFastFourierTransformUtilities::FFTRadixThree(unsigned int N, std::complex<double>* data, std::complex<double>* twiddle)
{

    if(HBitReversalPermutation::IsPowerOfBase(N,3) )
    {
        unsigned int logN = HBitReversalPermutation::LogBaseB(N,3);
        ...
        {
            //compute the width of each butterfly
            butterfly_width = HBitReversalPermutation::RaiseBaseToThePower(3,stage);
    ...
    {
        std::cout<<"HFastFourierTransformUtilities::FFTRadixThree: error, array has length: "<<N<<" which is not an integer power of 3."<<std::endl;
    }
...
unsigned int
HFastFourierTransformUtilities::ComputeBluesteinArraySize(unsigned int N)
{
    unsigned int M = 2*(N - 1);
    if( HBitReversalPermutation::IsPowerOfTwo(M))
    {
        return M;
    }
    else
    {
        return HBitReversalPermutation::NextLowestPowerOfTwo(M);
    }
}


void
HFastFourierTransformUtilities::ComputeBluesteinScaleFactors(unsigned int N, std::complex<double>* scale)
{
    //STEP A
...
void
HFastFourierTransformUtilities::ComputeBluesteinCirculantVector(
unsigned int N,
unsigned int M,
...
std::complex<double>* circulant) //must be size M
{
    ...
    HFastFourierTransformUtilities::FFTRadixTwo_DIF(M, circulant, twiddle);
}

void
HFastFourierTransformUtilities::FFTBluestein(
unsigned int N,
unsigned int M,
...
std::complex<double>* workspace) //must be size M
{
    ...
    HFastFourierTransformUtilities::FFTRadixTwo_DIF(M, (double*)(&(workspace[0])), (double*)(&(twiddle[0])) );
    ...
    HFastFourierTransformUtilities::FFTRadixTwo_DIT(M, (double*)(&(workspace[0])), (double*)(&(conj_twiddle[0])) );
