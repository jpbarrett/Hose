#ifndef HMultidimensionalFastFourierTransformFFTW_HH__
#define HMultidimensionalFastFourierTransformFFTW_HH__
...
/*
*
*@file HMultidimensionalFastFourierTransformFFTW.hh
*@class HMultidimensionalFastFourierTransformFFTW
*@brief
*@details
*
*/
...
{
    public:
        HMultidimensionalFastFourierTransformFFTW()
        {
            fTotalArraySize = 0;
            fInPtr = NULL;
            fOutPtr = NULL;
        ...
        virtual ~HMultidimensionalFastFourierTransformFFTW()
        {
            DealocateWorkspace();
            if(fInitialized)
            {
...
#endif /* HMultidimensionalFastFourierTransformFFTW_H__ */
