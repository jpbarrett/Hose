#ifndef HBitReversalPermutation_HH__
#define HBitReversalPermutation_HH__
...
/*
*
*@file HBitReversalPermutation.hh
*@class HBitReversalPermutation
*@brief
*@details
*
...
{
    public:
        HBitReversalPermutation(){};
        virtual ~HBitReversalPermutation(){};
...
#endif /* HBitReversalPermutation_H__ */
