#ifndef HPointwiseArrayReversedConjugateMultiplier_H__
#define HPointwiseArrayReversedConjugateMultiplier_H__
...
/**
*
*@file HPointwiseArrayReversedConjugateMultiplier.hh
*@class HPointwiseArrayReversedConjugateMultiplier
*@brief
*@details
*
...
class HPointwiseArrayReversedConjugateMultiplier: public HBinaryArrayOperator< std::complex<double>, NDIM>
{
    public:

        HPointwiseArrayReversedConjugateMultiplier()
        {
        ...
        virtual ~HPointwiseArrayReversedConjugateMultiplier()
        {
        ...
        virtual void Initialize()
        {
            ...
            if(!fInitialized && this->fFirstInput != NULL)
            {
                ...
                {
                    HArrayMath::RowMajorIndexFromOffset<NDIM>(i, fDim, fIndex);
                    for(unsigned int j=0; j<NDIM; j++){fIndex[j] = (fDim[j] - fIndex[j])%fDim[j];};
                    ri = HArrayMath::OffsetFromRowMajorIndex<NDIM>(fDim, fIndex);
...
#endif /* __HPointwiseArrayReversedConjugateMultiplier_H__ */
