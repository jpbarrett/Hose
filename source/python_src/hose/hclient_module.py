...
class hprompt(Cmd):
    ...
    def create_meta_data_file(self):
        ...
        for x in data_validity_info:
            obj_list.append(x)
        antenna_target_info = dbclient.get_measurement_from_time_range("antenna_target_status", start_time_stamp, end_time_stamp, 3)
        for x in antenna_target_info:
            obj_list.append(x)
        antenna_position_info = dbclient.get_measurement_from_time_range("antenna_position", start_time_stamp, end_time_stamp, 3)
